...
class StudentsDataGateway
{
    ...
    public function findByEmail($email) {
        $query = $this->db->prepare("SELECT name, surname, gender, group_number, email, points, birth_date, residence, password FROM students
        WHERE email = :email");
    ...
    public function updateStudent(Student $student, $email) {
        $query = $this->db->prepare("UPDATE students SET name =:name, surname =:surname, gender =:gender, group_number =:group_number,
          email =:email, points =:points, birth_date =:birth_date, residence =:residence WHERE email = :email");
        $query->bindValue(':email',$email,PDO::PARAM_STR );
    ...
    public function addStudent(Student $student) {
        $query = $this->db->prepare("INSERT INTO students( name, surname, gender, group_number, email, points, birth_date, residence, password ) 
        VALUES (:name, :surname, :gender, :group_number, :email, :points, :birth_date, :residence, :password)");
        $query->bindValue(':name',$student->name,PDO::PARAM_STR );
        $query->bindValue(':surname',$student->surname,PDO::PARAM_STR );
        $query->bindValue(':gender',$student->gender,PDO::PARAM_STR );
        $query->bindValue(':group_number',$student->group_number,PDO::PARAM_STR );
        ...
        $query->bindValue(':birth_date',$student->birth_date,PDO::PARAM_STR );
        $query->bindValue(':residence',$student->residence,PDO::PARAM_STR );
        $query->bindValue(':password',$student->password,PDO::PARAM_STR );
        $query->execute();
    ...
    public function getStudentList($sort = null, $page = null) {
        ...
        $query->execute();
        return $query->fetchAll(PDO::FETCH_CLASS|PDO::FETCH_PROPS_LATE, 'StudentList\Entities\Student');
    }
